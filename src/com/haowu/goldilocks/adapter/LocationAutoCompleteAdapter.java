...
public class LocationAutoCompleteAdapter extends ArrayAdapter<String> implements Filterable{
	...
	private static final String API_KEY = "AIzaSyDS_0hwnryPu9yTrhwOcAFQ5HhalNDf1x8";
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (v == null) {
			...
			v = vi.inflate(R.layout.location_search_item, null);
		}
		//set text of listview item.
		if (resultList != null) {
			TextView locationItem = (TextView) v.findViewById(R.id.tv_location_in_list);
			locationItem.setText(getItem(position));
		}
